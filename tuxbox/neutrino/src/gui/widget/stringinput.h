...
class CStringInput : public CMenuTarget
{
	...
	public:
		...
		CStringInput(const neutrino_locale_t Name, std::string* Value, int Size, bool ValueIsUtf8 = false, const neutrino_locale_t Hint_1 = NONEXISTANT_LOCALE, const neutrino_locale_t Hint_2 = NONEXISTANT_LOCALE, const char * const Valid_Chars= "0123456789. ", CChangeObserver* Observ = NULL, const char * const Icon = NULL);
		~CStringInput();
...
class CStringInputSMS : public CStringInput
{
	...
	public:
		...
		CStringInputSMS(const neutrino_locale_t Name, std::string* Value, int Size, bool ValueIsUtf8, const neutrino_locale_t Hint_1, const neutrino_locale_t Hint_2, const char * const Valid_Chars, CChangeObserver* Observ = NULL, const char * const Icon = NULL);
};
