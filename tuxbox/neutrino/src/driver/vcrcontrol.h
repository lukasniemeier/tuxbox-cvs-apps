 ...
 public:
	...
	class CFileAndServerDevice : public CDevice
		...
		protected:
			...
			std::string getMovieInfoString(const t_channel_id channel_id, const event_id_t epgid, const time_t epg_time, unsigned char apids, const bool stream_vtxt_pid);
